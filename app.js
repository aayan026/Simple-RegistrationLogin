...
Anchored by Wall Street in the Financial District, Manhattan, New York City has been called both the world's premier financial and fintech center[26][27] and the most economically powerful city in the world.[28] As of 2022, the New York metropolitan area is the largest metropolitan economy in the world, with a gross metropolitan product of over US$2.16 trillion.[9] If the New York metropolitan area were its own country, it would have the tenth-largest economy in the world. The city is home to the world's two largest stock exchanges by market capitalization of their listed companies: the New York Stock Exchange and Nasdaq. New York City is an established safe haven for global investors.[29] As of 2023, New York City is the most expensive city in the world for expatriates[30] and has by a wide margin the highest U.S. city residential rents;[31] and Fifth Avenue is the most expensive shopping street in the world.[32] New York City is home by a significant margin to the highest number of billionaires,[33] individuals of ultra-high net worth (greater than US$30 million),[34] and millionaires of any city in the world.`;


let count=0;
for (let index = 0; index < metn.length; index++) {
    let soz=metn.substring(index,index+8)
